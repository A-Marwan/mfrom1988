...
(function($) {
	...
	$(function() {
		...
		$('.aliens').on('mouseenter', function(){
			$(this).addClass('aliens-active');
		});
		$('.aliens').on('mouseleave', function(){
			$(this).removeClass('aliens-active');
		});
		$('.aliens').on('click', function(){
			window.location = "file:///home/marwan/Downloads/html5up-overflow/images/howDidIGetAJob.jpg";
		});
